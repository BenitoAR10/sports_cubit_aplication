...
class LENclientsService {
  String backendUrlBase = host.backendUrlBase;

  Future<List<ClientesLenDto>> getClientesLEN(int id) async {
    List<ClientesLenDto> result;
    String backendUrlBase = host.backendUrlBase;
    var uri =
        Uri.parse("$backendUrlBase/api/v1/Entrenador/$id/clientesActivos");
    ...
    if (response.statusCode == 200) {
      ...
      if (backendResponse.success) {
        result = (backendResponse.data as List<dynamic>)
            .map((e) => ClientesLenDto.fromJson(e))
            .toList();
      } else {
